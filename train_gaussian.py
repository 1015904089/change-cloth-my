...
import warnings
from models.Gaussian_Trainer import Trainer_GS
...
if __name__ == '__main__':
    ...
    parser.add_argument('--densification_interval', type=float, default=10,help="200")
    parser.add_argument('--opacity_reset_interval', type=float, default=10,help="2000")
    parser.add_argument('--densify_from_iter', type=float, default=10,help="500")
    ...
    parser.add_argument("--skip_triangle_walk", action='store_false')
    ...
    """
     ...
     dataset,
     """
    trainer = Trainer_GS(opt, model, workspace=opt.workspace,
                          pc_dir = opt.data_path, dataset = valid_dataset)
