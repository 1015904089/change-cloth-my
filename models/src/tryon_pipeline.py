...
class StableDiffusionXLInpaintPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        a = torch.load("/home/jian/CHANGE_CLOTH/asd.pt")
        cloth = a["cloth_latents"] 
        text_embeds_cloth=a["encoder_hidden_states_c"]
        mask=a["mask"]
        masked_image_latents = a["masked_image_latents"] 
        pose_img=a["pose_img_latents"]
        add_text_embeds = a["add_text_embeds"]
        add_time_ids = a["add_time_ids"]
        image_embeds=a["image_embeds"]
        latents=a["noise"]
        prompt_embeds = a["prompt_embeds"]
        assert pose_img.shape==masked_image_latents.shape
        """
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # a = self.decode_latents(self.scheduler.step( noise_pred, t, latents, eta=0)["pred_original_sample"])
