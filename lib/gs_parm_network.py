...
from models.GPS.core.extractor import UnetExtractor, ResidualBlock


class GSRegresser(nn.Module):
    def __init__(self, cfg, rgb_dim=3, depth_dim=1, norm_fn='group'):
        super().__init__()
        self.rgb_dims = cfg.raft_encoder_dims
        self.depth_dims = cfg.gsnet_encoder_dims
        self.decoder_dims = cfg.gsnet_decoder_dims
        self.head_dim = cfg.parm_head_dim
